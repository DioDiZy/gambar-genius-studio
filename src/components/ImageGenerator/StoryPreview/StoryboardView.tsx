      ...
      {isGenerating ? (
        <div className="text-center p-6">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-muted-foreground">Membuat storyboard Anda...</p>
          </div>
        </div>
      ) : imageUrls.length > 0 ? (
        <div className="space-y-4">
          ...
          <div className="p-3 bg-muted/20 rounded-md border text-sm overflow-y-auto max-h-28">
            <h4 className="font-medium text-xs uppercase text-muted-foreground mb-1">Adegan {currentIndex + 1}</h4>
        ...
        <div className="text-center p-6">
          ...
          <p className="text-muted-foreground text-sm">Storyboard Anda akan muncul di sini</p>
        </div>
      )}
    </div>
  );
